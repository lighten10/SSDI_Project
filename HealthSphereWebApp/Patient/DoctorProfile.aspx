<%@ Page Title="" Language="C#" MasterPageFile="~/Patient/PatientMaster.Master" AutoEventWireup="true" CodeBehind="DoctorProfile.aspx.cs" Inherits="HealthSphereWebApp.DoctorProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-left: 20%">
        ...
        <br />
        <h1><strong style="margin: 20%">Doctor's Profile</strong></h1>
        <br />
        <br />
